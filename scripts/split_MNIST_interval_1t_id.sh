GPUID=$1
OUTDIR=outputs/split_MNIST_interval_1_id
REPEAT=10
mkdir -p $OUTDIR

# Incremental Domain
python -u intervalBatchLearn.py --gpuid $GPUID --repeat $REPEAT --optimizer Adam --force_out_dim 2 \
       --first_split_size 2 --other_split_size 2 --schedule 10 --batch_size 128 \
...
python -u intervalBatchLearn.py --gpuid $GPUID --repeat $REPEAT --optimizer Adam --force_out_dim 2 \
       --first_split_size 2 --other_split_size 2 --schedule 20 --batch_size 128 \
       --model_name interval_mlp400 --agent_type interval --agent_name IntervalNet \
...
python -u intervalBatchLearn.py --gpuid $GPUID --repeat $REPEAT --optimizer Adam --force_out_dim 2 \
       --first_split_size 2 --other_split_size 2 --schedule 10 --batch_size 128 \
       --model_name interval_mlp400 --agent_type interval --agent_name IntervalNet \
       --lr 0.01 --kappa_epoch 10 --epssplit_MNIST_interval_id.sh_epoch 10 --eps_max 0.1 | tee ${OUTDIR}/Adam_exp3.log
